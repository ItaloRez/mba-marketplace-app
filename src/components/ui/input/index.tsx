...
const inputStyle = tva({
  base: 'border-background-300 flex-row content-center data-[hover=true]:border-outline-400 data-[focus=true]:border-primary-700 data-[focus=true]:hover:border-primary-700 data-[disabled=true]:opacity-40 data-[disabled=true]:hover:border-background-300 items-center',
...
const inputFieldStyle = tva({
  base: 'flex-1 text-typography-900 py-0 px-3 placeholder:text-grayscale-200 placeholder:mt-1 placeholder:text-body-md h-full ios:leading-[0px] web:cursor-text web:data-[disabled=true]:cursor-not-allowed',
